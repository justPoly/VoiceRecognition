...
namespace UnityChan
{
    ...
    public class UnityChanControlScriptWithRgidBody : MonoBehaviour
    {
        ...
        //CYJu private GameObject cameraObject;	// メインカメラへの参照
        ...
        void Start()
        {
            ...
            //メインカメラを取得する
            //CYJu cameraObject = GameObject.FindWithTag ("MainCamera");
        ...
        void FixedUpdate()
        {
            ...
            */
            ...
            {
                //CYJu cameraObject.SendMessage ("setCameraPositionJumpView");	// ジャンプ中のカメラに変更
                // ステートがトランジション中でない場合
                if (!anim.IsInTransition(0))
                {
